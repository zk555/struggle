...
public class MD5Utils {
    ...
    public static void main(String [] args ){
        ...
        String ss = "test";
        System.out.println(MD5Utils.encode32(ss));
        System.out.println(MD5Utils.encode32ToUpperCase(ss));
        System.out.println(MD5Utils.encode16(ss));
        System.out.println(MD5Utils.encode16ToUpperCase(ss));
    }
}
