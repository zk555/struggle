package com.gy.struggle.qrCode.utils.Weixin;

import com.gy.struggle.qrCode.utils.Base64;
import com.gy.struggle.qrCode.utils.HttpClientUtil;
import com.gy.struggle.qrCode.utils.MD5Utils;
import com.gy.struggle.qrCode.utils.StringUtil;
...
public class WxCommonUtil {
    ...
    public final static String md5Sign(Map<String, Object> paramMap, String key) {
        ...
        String sign = MD5Utils.encode32ToUpperCase(payParam);
    ...
    public static String rsaEncrypt(String content, String ciphertext) throws Exception {
        ...
        return com.gy.struggle.qrCode.utils.Base64.encode(ci.doFinal(content.getBytes("UTF-8")));
    }
